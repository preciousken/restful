...
import LatestProductTitle from './Titles/LatestProductTitle'
...
const LatestProduct = () => {
    ...
    useEffect(()=>{
        ...
        const fetchAllProducts= async ()=>{
         try {
            await axios.get(`${URL}/product/latestProduct`, {signal: controller.signal}).then((response)=>{
    ...
    return (
      <div className="maincontainer ">
        <div className="title">Latest Products</div>
          <div className='half latestproduct '>
